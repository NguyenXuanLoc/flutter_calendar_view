...
class InternalDayViewPage<T extends Object?> extends StatefulWidget {
  ...
  const InternalDayViewPage({
    Key? key,
    this.startHoursWidget, this.endHoursWidget,
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(children: [
                if(widget.startHoursWidget != null) widget.startHoursWidget!,
                SizedBox(
                  height: widget.height,
                  width: widget.width,
                  child: Stack(
                      ...
                      if (widget.showHalfHours)
                        CustomPaint(
                          ...
                          painter: HalfHourLinePainter(
                            ...
                            lineStyle: widget.halfHourIndicatorSettings
                                .lineStyle,
                            dashWidth: widget.halfHourIndicatorSettings
                                .dashWidth,
                            dashSpaceWidth:
                      ...
                      if (widget.showQuarterHours)
                        CustomPaint(
                          ...
                          painter: QuarterHourLinePainter(
                            lineColor: widget.quarterHourIndicatorSettings
                                .color,
                            lineHeight:
                ...
                if(widget.endHoursWidget != null) widget.endHoursWidget!
